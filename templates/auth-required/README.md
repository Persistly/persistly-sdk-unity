...
Use this template when your game requires Firebase, Supabase, or Auth0 sign-in before cloud sync.
...
- `PersistlySaveService.cs` configures auth-required mode, signs in with a Firebase ID token, Supabase access token, or Auth0 token, saves locally, syncs, and signs out.
