...
```text
https://github.com/Persistly/persistly-sdk-unity.git#v1.3.0
```
...
```bash
Scripts/package_release.sh 1.3.0
```

This creates:

```text
dist/persistly-unity-sdk-1.3.0.tgz
```
